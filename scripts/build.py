...
<script src="/assets/js/legacy.js" defer data-param="{kind}" data-map='{json.dumps(table)}'></script>
...
def headers():
    return f"""# Cloudflare Pages / Netlify. Generated by scripts/build.py — edit the generator.
/*
...
# CSS and JS are requested with ?v=<content hash>, so a change is a new URL.
/assets/css/*
